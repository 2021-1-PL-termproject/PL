...
def user(usr):
    ...
    zValueScore = zValueScore(usr)
    goOut = goOut(usr)
    goOutMean = goOutMeang(usr)
    ...
    return render_template('main.html', usr=usr, name=name,
                           ...
                           exer = exer, exermean = exermean, exerMent = exerMent, zValueScore = zValueScore,
                           goOut = goOut, goOutMean = goOutMean)
